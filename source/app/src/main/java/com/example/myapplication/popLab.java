...
public class popLab extends AppCompatActivity {
    private TextView clinicName,role,serviceDescription;
    private String serviceName = "laboratory";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_lab);
                ...
                for(DataSnapshot child : dataSnapshot.getChildren()){
                    ...
                    if(child.getKey().equals(serviceName)){
                        ...
                        for(DataSnapshot child1 : child.getChildren()){
                            ...
                            TextView textView0 = new TextView(popLab.this);
                            TextView textView1 = new TextView(popLab.this);
                            TextView textView2 = new TextView(popLab.this);
                            TextView textView3 = new TextView(popLab.this);
