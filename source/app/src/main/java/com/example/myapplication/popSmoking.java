...
public class popSmoking extends AppCompatActivity {
    private TextView clinicName,role,serviceDescription;
    private String serviceName = "smoking";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_smoking);
                ...
                for(DataSnapshot child : dataSnapshot.getChildren()){
                    ...
                    if(child.getKey().equals(serviceName)){
                        ...
                        for(DataSnapshot child1 : child.getChildren()){
                            ...
                            TextView textView0 = new TextView(popSmoking.this);
                            TextView textView1 = new TextView(popSmoking.this);
                            TextView textView2 = new TextView(popSmoking.this);
                            TextView textView3 = new TextView(popSmoking.this);
