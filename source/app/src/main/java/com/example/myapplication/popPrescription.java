...
public class popPrescription extends AppCompatActivity {
    private TextView clinicName,role,serviceDescription;
    private String serviceName = "prescription";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_prescription);
                ...
                for(DataSnapshot child : dataSnapshot.getChildren()){
                    ...
                    if(child.getKey().equals(serviceName)){
                        ...
                        for(DataSnapshot child1 : child.getChildren()){
                            ...
                            TextView textView0 = new TextView(popPrescription.this);
                            TextView textView1 = new TextView(popPrescription.this);
                            TextView textView2 = new TextView(popPrescription.this);
                            TextView textView3 = new TextView(popPrescription.this);
