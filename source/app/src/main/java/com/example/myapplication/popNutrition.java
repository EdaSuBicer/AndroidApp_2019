...
public class popNutrition extends AppCompatActivity {
    private TextView clinicName,role,serviceDescription;
    private String serviceName = "nutrition";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_nutrition);
                ...
                for(DataSnapshot child : dataSnapshot.getChildren()){
                    ...
                    if(child.getKey().equals(serviceName)){
                        ...
                        for(DataSnapshot child1 : child.getChildren()){
                            ...
                            TextView textView0 = new TextView(popNutrition.this);
                            TextView textView1 = new TextView(popNutrition.this);
                            TextView textView2 = new TextView(popNutrition.this);
                            TextView textView3 = new TextView(popNutrition.this);
