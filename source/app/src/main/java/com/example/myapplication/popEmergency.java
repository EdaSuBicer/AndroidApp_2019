...
public class popEmergency extends AppCompatActivity {
    private TextView clinicName,role,serviceDescription;
    private String serviceName = "emergency";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_emergency);
                ...
                for(DataSnapshot child : dataSnapshot.getChildren()){
                    ...
                    if(child.getKey().equals(serviceName)){
                        ...
                        for(DataSnapshot child1 : child.getChildren()){
                            ...
                            TextView textView0 = new TextView(popEmergency.this);
                            TextView textView1 = new TextView(popEmergency.this);
                            TextView textView2 = new TextView(popEmergency.this);
                            TextView textView3 = new TextView(popEmergency.this);
