...
public class popVaccination extends AppCompatActivity {
    private TextView clinicName,role,serviceDescription;
    private String serviceName = "vaccination";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_vaccination);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for(DataSnapshot child : dataSnapshot.getChildren()){
                                ...
                                for(DataSnapshot child1 : child.getChildren()){
                                    ...
                                    TextView textView0 = new TextView(popVaccination.this);
                                    TextView textView1 = new TextView(popVaccination.this);
                                    TextView textView2 = new TextView(popVaccination.this);
                                    TextView textView3 = new TextView(popVaccination.this);
