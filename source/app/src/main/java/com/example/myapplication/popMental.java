...
public class popMental extends AppCompatActivity {
    private TextView clinicName,role,serviceDescription;
    private String serviceName = "mental";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pop_mental);
                ...
                for(DataSnapshot child : dataSnapshot.getChildren()){
                    ...
                    if(child.getKey().equals(serviceName)){
                        ...
                        for(DataSnapshot child1 : child.getChildren()){
                            ...
                            TextView textView0 = new TextView(popMental.this);
                            TextView textView1 = new TextView(popMental.this);
                            TextView textView2 = new TextView(popMental.this);
                            TextView textView3 = new TextView(popMental.this);
